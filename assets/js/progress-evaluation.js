let evaluations = [
    { week: 'Tuần 1', contract: 'Hợp đồng vệ sinh A', supplier: 'Công ty X', onTime: 95, avgScore: 8.5, notes: '' },
    { week: 'Tuần 2', contract: 'Hợp đồng điện B', supplier: 'Công ty Y', onTime: 90, avgScore: 8.0, notes: 'Cần cải thiện giao hàng' },
    { week: 'Tuần 3', contract: 'Hợp đồng bảo trì C', supplier: 'Công ty Z', onTime: 85, avgScore: 7.5, notes: '' },
    { week: 'Tuần 4', contract: 'Hợp đồng vệ sinh D', supplier: 'Công ty X', onTime: 92, avgScore: 8.2, notes: 'Tốt' },
    { week: 'Tuần 5', contract: 'Hợp đồng điện E', supplier: 'Công ty Y', onTime: 88, avgScore: 7.8, notes: '' },
    { week: 'Tuần 6', contract: 'Hợp đồng bảo trì F', supplier: 'Công ty Z', onTime: 80, avgScore: 7.0, notes: 'Trễ tiến độ' },
    { week: 'Tuần 7', contract: 'Hợp đồng vệ sinh G', supplier: 'Công ty X', onTime: 97, avgScore: 9.0, notes: 'Xuất sắc' },
    { week: 'Tuần 8', contract: 'Hợp đồng điện H', supplier: 'Công ty Y', onTime: 91, avgScore: 8.3, notes: '' },
    { week: 'Tuần 9', contract: 'Hợp đồng bảo trì I', supplier: 'Công ty Z', onTime: 87, avgScore: 7.6, notes: 'Cần kiểm tra lại' },
    { week: 'Tuần 10', contract: 'Hợp đồng vệ sinh J', supplier: 'Công ty X', onTime: 94, avgScore: 8.7, notes: '' }
];
...
function renderTable(page) {
    ...
    currentEvaluations.forEach((eval, index) => {
        ...
        if (editIndex === index) {
            row.innerHTML = `
              <td data-label="Tuần">${eval.week}</td>
