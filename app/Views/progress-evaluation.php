...
<body>
    <div id="main">
        <div class="row">
            ...
            <div class="col-sm-10 col-7">
                ...
                <div class="container">
                    ...
                    <!-- Search and Filter -->
                    <div class="container-fluid bg-light py-3 mb-3 border-bottom">
                ...
                <div id="noteModal" class="modal">
                    <div class="modal-content">
                        ...
                        <button class="note-btn" onclick="closeModal()">Hủy</button>
                    </div>
                </div>
        ...
        <script src="/assets/js/progress-evaluation.js"></script>
</body>
