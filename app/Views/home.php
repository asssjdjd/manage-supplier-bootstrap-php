                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item" id ="home">
                                <a class="nav-link"
                                    href="/BT3/public/index.php?page=dashboard">  
    ...
    <div id="content1" class="container">
        ...
        <div class="row leftElement">
            ...
            <div class="col-md-6 col-12 rightElement">
                <div class="mt-4">
                    <img src="<?= asset('public/assets/images/content2.avif') ?>" alt="" width="100%">
                </div>
                ...
                <div id="carousel1" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="<?= asset('public/assets/images/supplier.jpg') ?>" alt="Slide 1">
                        </div>
                        <div class="carousel-item">
                            <img src="<?= asset('public/assets/images/supplier2.jp') ?>" alt="Slide 2">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div id="carousel2" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="<?= asset('public/assets/images/contract1.jpg') ?>" alt="Slide 1">
                            </div>
                            <div class="carousel-item">
                                <img src="<?= asset('public/assets/images/contract2.jpg') ?>" alt="Slide 2">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div id="carousel3" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="<?= asset('public/assets/images/history.jpg') ?>" alt="Slide 1">
                        </div>
                        <div class="carousel-item">
                            <img src="<?= asset('public/assets/images/sendemail.jpg') ?>" alt="Slide 2">
                        </div>
                    </div>
                </div>
            </div>
