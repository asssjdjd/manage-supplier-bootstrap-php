            ...
            <div class="col-sm-10 col-7">
                ...
                <div class="container">
                    ...
                    <div class="pagination d-flex justify-content-center align-items-center mt-3">
                        <button class="btn btn-primary me-2" id="prevPage" disabled>Trước</button>
                        <span id="pageInfo">Page 1 of 1</span>
                        <button class="btn btn-primary ms-2" id="nextPage" disabled>Sau</button>
                    </div>
